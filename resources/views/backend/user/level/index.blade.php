...
<div class="container-fluid star-main-font">
	<div class="clearfix star-mt-20 star-mb-20">
		...
		<div class="pull-right">
			<button type="button" class="btn btn-sm btn-primary" onclick="starAdd('user/level');">新增</button>
		</div>
	</div>
	...
	<table class="table table-condensed table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<button type="button" class="btn btn-sm btn-primary" onclick="starAdd('user/level', {{$item['id']}});">编辑</button>
