...
<div class="container-fluid star-main-font">
	<div class="clearfix star-mt-20 star-mb-20">
		...
		<div class="pull-right">
			...
			@endif
			<button type="button" class="btn btn-sm btn-primary" onclick="starShow('menu', 0, {{$parent}});">新增</button>
		</div>
	</div>
	{{csrf_field()}}
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<button type="button" class="btn btn-sm btn-primary" onclick="starShow('menu', {{$item['id']}}, {{$parent}});">编辑</button>
